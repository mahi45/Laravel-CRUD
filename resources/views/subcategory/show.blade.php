...
@section('content')
    <div class="w-2/5 m-auto shadow-xl card bg-base-100">
        <div class="card-body">
            <h2 class="text-2xl card-title">Show Subcategory</h2>

            <div>
                <div class="label">
                    <span class="font-semibold label-text">Category Name</span>
                </div>
                <select class="w-full max-w-xs select select-bordered" name="category_id" disabled>
            ...
            <div>
                ...
                <input type="text" placeholder="Subcategory Name" class="w-full max-w-xs input input-bordered" name="subcategory_name" value="{{ $subcategory->name }}" disabled />
            </div>
